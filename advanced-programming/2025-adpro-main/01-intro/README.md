...
```
openjdk    v. 21.0.8  you need to install, other versions might work
scala-cli  v. 1.8.5   you need to install
scala      v. 3.7.2   installed and configured automatically for you

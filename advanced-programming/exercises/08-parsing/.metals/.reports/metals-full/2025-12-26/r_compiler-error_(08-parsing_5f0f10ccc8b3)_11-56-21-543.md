error id: E8EBEBB79DB36B7BA58C6F4ABEDC3720
...
Classpath:
<WORKSPACE>/.scala-build/08-parsing_0f10ccc8b3/classes/main [exists ], <HOME>/.cache/coursier/v1/https/repo1.maven.org/maven2/org/scala-lang/scala3-library_3/3.7.2/scala3-library_3-3.7.2.jar [exists ], <HOME>/.cache/coursier/v1/https/repo1.maven.org/maven2/org/scalacheck/scalacheck_3/1.19.0/scalacheck_3-1.19.0.jar [exists ], <HOME>/.cache/coursier/v1/https/repo1.maven.org/maven2/org/scala-lang/scala-library/2.13.16/scala-library-2.13.16.jar [exists ], <HOME>/.cache/coursier/v1/https/repo1.maven.org/maven2/org/scala-sbt/test-interface/1.0/test-interface-1.0.jar [exists ], <HOME>/.cache/coursier/v1/https/repo1.maven.org/maven2/com/sourcegraph/semanticdb-javac/0.10.0/semanticdb-javac-0.10.0.jar [exists ], <WORKSPACE>/.scala-build/08-parsing_0f10ccc8b3/classes/main/META-INF/best-effort [missing ]
Options:
...
scala.runtime.Scala3RunTime$.assertFailed(Scala3RunTime.scala:8)
	dotty.tools.dotc.util.Spans$Span$.start$extension(Spans.scala:45)
	dotty.tools.pc.PcSymbolSearch$.selectNameSpan(PcSymbolSearch.scala:253)
	dotty.tools.pc.PcSymbolSearch.soughtSymbols(PcSymbolSearch.scala:86)
	dotty.tools.pc.PcSymbolSearch.soughtSymbols(PcSymbolSearch.scala:50)
	dotty.tools.pc.PcSymbolSearch.soughtSymbols$(PcSymbolSearch.scala:23)
	dotty.tools.pc.WithSymbolSearchCollector.soughtSymbols$lzyINIT1(PcCollector.scala:343)
	dotty.tools.pc.WithSymbolSearchCollector.soughtSymbols(PcCollector.scala:343)
	dotty.tools.pc.WithSymbolSearchCollector.result(PcCollector.scala:350)
	dotty.tools.pc.PcDocumentHighlightProvider.highlights(PcDocumentHighlightProvider.scala:33)
	dotty.tools.pc.ScalaPresentationCompiler.documentHighlight$$anonfun$1(ScalaPresentationCompiler.scala:225)
```
#### Short summary: 

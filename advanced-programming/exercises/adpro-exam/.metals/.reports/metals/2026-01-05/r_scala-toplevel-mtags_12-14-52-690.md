error id: file://<WORKSPACE>/Exam.scala:[1521..1522) in Input.VirtualFile("file://<WORKSPACE>/Exam.scala", "/* Exam: Advanced Programming, by Andrzej Wasowski
...
object RMSE:
  ...
  def[LazyList: Arbitrary[(LazyList[Double, LazyList[Double]])]] runningRMSEProperty(using arb: Arbitrary[(LazyList[Double], LazyList[Double])]): Prop = 
    forAll {(lists: (LazyList[Double], LazyList[Double])) =>   
...
file://<WORKSPACE>/Exam.scala:61: error: expected identifier; obtained lbracket

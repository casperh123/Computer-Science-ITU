error id: file://<WORKSPACE>/Exam.scala:toInt.
file://<WORKSPACE>/Exam.scala
empty definition using pc, found symbol in pc: toInt.
...
non-local guesses:
	 ...
	 -Prop.s.toInt#
	 -Prop.s.toInt().
	 -org/scalactic/TripleEquals.s.toInt.
	 -org/scalactic/TripleEquals.s.toInt#
	 -org/scalactic/TripleEquals.s.toInt().
	 -adpro/state/s/toInt.
	 -adpro/state/s/toInt#
	 -adpro/state/s/toInt().
	 -adpro/parsing/s/toInt.
	 -adpro/parsing/s/toInt#
	 -adpro/parsing/s/toInt().
	 -adpro/parsing/Sliceable.s.toInt.
	 -adpro/parsing/Sliceable.s.toInt#
	 -adpro/parsing/Sliceable.s.toInt().
	 -s/toInt.
	 -s/toInt#
	 -s/toInt().
	 -scala/Predef.s.toInt.
	 -scala/Predef.s.toInt#
	 -scala/Predef.s.toInt().
offset: 10022
...
object IntervalParser2:
 ...
 succeed(None)
    ...
    extension[P[+_]] (p: Parsers[ParseError, P])
      def intBetween(low: Int, hight: Int): Parser[Option[Int]] = 
        p.map { s => 
          val n = s.toI@@nt

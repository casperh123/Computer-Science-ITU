...
### scala.MatchError: TypeDef(P,LambdaTypeTree(List(TypeDef(_$2,TypeBoundsTree(EmptyTree,EmptyTree,EmptyTree))),TypeBoundsTree(EmptyTree,EmptyTree,EmptyTree))) (of class dotty.tools.dotc.ast.Trees$TypeDef)
...
object IntervalParser2:
 ...
 succeed(None)
    ...
    extension[P[+_]] (p: Parsers[ParseError, P])
      ...
      def intBetween(low: Int, hight: Int): P[Option[Int]] = 
        p.regex("[0-9]".r)
          (n => )
